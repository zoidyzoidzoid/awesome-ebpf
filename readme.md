...
- [SkyWalking Rover](https://github.com/apache/skywalking-rover) - [Apache SkyWalking](https://skywalking.apache.org/) is often a go-to choice of open-source Application Performance monitoring (APM) platform for distributed systems with microservices, cloud-native and container-based (Kubernetes) architectures. SkyWalking Rover is a project under active development in the ecosystem as an eBPF-based profiler for C, C++, Golang, and Rust applications. It efficiently collects runtime metrics for further analysis.
